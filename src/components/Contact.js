...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(result.code === 200) {
            ...
            setStatus({ success: false, message: 'something went wrong :c   ---please try again latter'})
        }
    };
                        ...
                        <form onSubmit={handleSubmit}>
                            <Row>
                                <Col sm={6} className="px-1">
                                    <input type="text" value={formDetails.firstName} placeholder="First Name" onChange={(e) => onFormUpdate('fistName', e.target.value)}></input>
                                </Col>
                                <Col sm={6} className="px-1">
